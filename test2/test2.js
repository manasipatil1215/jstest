...
// 22 String Method
const nam= "Manasi PATIL";
// console.log(nam.slice(6,9));
// console.log(nam.substring(3,6));
// console.log(nam.substr(7,11));
...
console.log(ConcatenateString("Manasi","Patil"))

// 25 Sort An Array
const arr9 = ["cherry", "apple","guava"];
...
console.log(strValidation("abc@xyz.com"))

// 22) String Methods
// Substring() - In this negative number are treated as 0
let fruits1 = "cherry , berry , banana";
...
let fruits2 = ["cherry", "apple", "watermelon", "strawberry", "mango"];
